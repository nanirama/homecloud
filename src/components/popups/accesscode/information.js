...
return(
    <>
               <Popup>
                  ...
                  <TextBlock>
                      <p>Please provide your information below and we’ll contact the current homeowner to schedule the Certification at a convenient time for them.</p>
                  </TextBlock>
  ...
  />
                      {/* <Select options={options} id="service_type" name="service_type" /> */}
                      {/* <select id="service_type" name="service_type">
                          <option>
                          Select all the services that may apply
                          </option>
                          <option>Certification</option>
                          <option>Radon Test</option>
                          <option>Wood Destroying Insects</option>
                          <option>Well Water</option>
                      </select> */}
                     <label>Your First Name</label>
                     <input type="text" placeholder="First Name" name="firstname" id="firstname" />
                     <label>Your Last Name</label>
                     <input type="text" placeholder="Last Name" id="lastname" placeholder="Last Name" />
                     <label>Your Email Address</label>
                     <input type="text" placeholder="Email Address" id="email" name="email" />
                     <label>Current Homeowner Email*</label>
                     <input type="text" placeholder="Email Address" id="homeowner_email" name="homeowner_email" />
                     <label>Selling Real Estate Agent Email</label>
                     <input type="text" placeholder="Email Address" id="agent_email" name="agent_email" />
                     </FormInner>
                     <FormBtn>
                     <input type="submit" value="Submit" className="btn" disabled={isSubmitting}/>
                     {/* <Button onClick={e=>(setFormStep('step8'))} className="btn">Submit</Button> */}
                     </FormBtn>
                     </FormBlk>
                     </form>
               </Popup>          
